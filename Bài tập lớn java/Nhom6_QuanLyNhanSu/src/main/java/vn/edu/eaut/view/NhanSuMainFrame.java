...
public class NhanSuMainFrame extends JFrame {
    ...
    public NhanSuMainFrame() {
        ...
        setTitle("Quản Lý Nhân Sự | PHÒNG NHÂN SỰ");
        setSize(1280, 800);
        ...
        panelCenter.add(new NhanVienFrame("NHANSU"), "NHAN_VIEN");
        ...
        panelCenter.add(new ChamCongFrame("NHANSU"), "CHAM_CONG");
    ...
    private JPanel createHeader() {
        ...
        JLabel logo = new JLabel("NS", SwingConstants.CENTER);
        ...
        JLabel sub = new JLabel("PHÒNG NHÂN SỰ");
        ...
        JLabel info = new JLabel("<html><b>Phòng Nhân Sự</b><br><font size='2'>NhanSu • Đang hoạt động</font></html>");
    ...
    private JPanel createFooter() {
        ...
        JLabel right = new JLabel("  NhanSu • PHÂN HỆ ĐƯỢC PHÂN QUYỀN  ");
